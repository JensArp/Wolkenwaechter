 ...
 * Slug: Gamestarter/page-newsletter-landing
 * Categories: call-to-action, Gamestarter_page, featured
 * Keywords: starter
	...
	<div class="wp-block-group">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button">
				<a class="wp-block-button__link wp-element-button"><?php echo esc_html_x( 'Sign up', 'Sample content for newsletter subscribe button', 'Gamestarter' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
